...
<div class="row" id="konten">
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="img/home/galeri.jpg" alt="" width="100%" height="310px">
      <div class="caption">
        <h3>Galeri</h3>
        <p>Potret daerah Indramayu & destinasi wisata nya.</p>
        <p><a href="index.php?page=galeri" class="btn btn-primary" role="button">Lihat</a> <a href="#" class="btn btn-default" role="button"></a></p>
      </div>
    </div>
  </div>
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="img/home/babad.jpg" width="100%" height="230px" alt="">
      <div class="caption">
        <h3>Babad Dermayu</h3>
        ...
        <p><a href="index.php?page=babad" class="btn btn-primary" role="button">Lihat</a> <a href="" class="btn btn-default" role="button"></a></p>
      </div>
    </div>
  </div>
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="img/home/news.jpg" width="100%" height="253px">
        <div class="caption">
...
<div class="row" id="konten">
  <div class="col-sm-6 col-md-3">
    <div class="thumbnail">
      <img src="img/home/pelajaran.jpg" alt="" width="100%" height="281px">
      <div class="caption">
        <h3>Pelajaran</h3>
        <p>Merupakan isi dari penerapan kehidupan sehari-hari masyarakat indramayu </p>
        <p><a href="index.php?page=pelajaran" class="btn btn-primary" role="button">Lihat</a> <a href="" class="btn btn-default" role="button"></a></p>
      </div>
    </div>
  </div>
  <div class="col-sm-6 col-md-3">
    <div class="thumbnail">
      <img src="img/home/aksara.png" alt="" width="100%" height="200px">
      <div class="caption">
        <h3>Aksara Jawa</h3>
  ...
  <div class="col-sm-6 col-md-3">
    <div class="thumbnail">
      <img src="img/home/materi.jpg" alt="" width="100%" height="207px">
      <div class="caption">
        ...
        <p>
        <a href="index.php?page=mudah" class="btn btn-primary" role="button">Mudah</a>
        <a href="index.php?page=sedang" class="btn btn-primary" role="button">Sedang</a>
        <a href="index.php?page=sulit" class="btn btn-primary" role="button">Sulit</a>
        </p>
      </div>
    </div>
  </div>
  <div class="col-sm-6 col-md-3">
    <div class="thumbnail">
      <img src="img/home/apaitu.jpg" alt="" width="100%" height="196px">
      <div class="caption">
        ...
        <p><a href="index.php?page=apaitu" class="btn btn-primary" role="button">Lihat</a> <a href="#" class="btn btn-default" role="button"></a></p>
      </div>
    </div>
  </div>
</div>
         <div class="row" id="konten">
          ...
          <div class="col-sm-6 col-md-3">
            <div class="thumbnail">
              <img src="img/home/pertanyaan.jpg" width="100%" height="307px">
              <div class="caption">
                <h3>Daftar Pertanyaan </h3>
                <p>Lihat Daftar Pertanyaan dari pengunjung yang lain, klik tombol di bawah !!!</p>
                <p><a href="index.php?page=pertanyaan" class="btn btn-primary" role="button">Lihat</a> <a href="#" class="btn btn-default" role="button"></a></p>
              </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-3">
            <div class="thumbnail">
              <img src="img/home/kontak.jpg" width="100%" height="340px">
              <div class="caption">
                <h3>Contact</h3>
                <p>Silahkan ajukan pertanyaan, kritik & saran anda untuk memperbaiki website kami</p>
                <p><a href="index.php?page=contact" class="btn btn-primary" role="button">Lihat</a> <a href="#" class="btn btn-default" role="button"></a></p>
              </div>
            </div>
          </div>
          <?php
