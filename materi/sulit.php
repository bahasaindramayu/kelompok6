        ...
        .thumbnails{
          ...
          <div class="col-sm-3 col-md-3">
            <div class="thumbnail thumbnails">
              <img src="img/sulit/materi<?php echo $isi['Id_materi'] ?>.jpg" width="100%" height="250">
                <div class="caption">
                  <h3><?php echo $isi['judul_materi'] ?></h3>
                  <p><a href="index.php?page=materi1<?php echo $isi['Id_materi'] ?>" class="btn btn-primary" role="button">Lihat</a> </p>
                </div>
            </div>
          </div>
        <?php } ?> 
